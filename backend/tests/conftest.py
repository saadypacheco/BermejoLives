...
class FakeRepo:
    ...
    def __init__(self):
        ...
        # Los mismos que dejan las migraciones 0101/0102/0108: si el fake
        # trajera otros, los tests pasarían contra una realidad que no existe.
        self.planes: dict[str, dict] = {
            "gratis":    {"slug": "gratis", "nombre": "Básico", "orden": 0,
                          "precio_mes": 0, "publicaciones_mes": 50, "publica_meses": 2,
                          "precio_publicacion_extra": 5, "permite_extras": True,
                          "moneda": "BOB", "funciones": {}, "activo": True, "visible": True,
                          "descripcion": "Aparecé en el mapa de Bermejo. Gratis por un mes.", "incluye": []},
            "publica":   {"slug": "publica", "nombre": "Publica", "orden": 1,
                          "precio_mes": 70, "publicaciones_mes": 25, "publica_meses": None,
                          "precio_publicacion_extra": 5, "permite_extras": True,
                          "moneda": "BOB", "funciones": {"negocio_digital": True}, "activo": True, "visible": True,
                          "descripcion": "Tu negocio digitalizado.", "incluye": []},
            ...
            "premium":   {"slug": "premium", "nombre": "Premium (viejo)", "orden": 9,
                          "precio_mes": 140, "publicaciones_mes": 50, "publica_meses": None,
                          "precio_publicacion_extra": 5, "permite_extras": True,
                          "moneda": "BOB", "funciones": {"negocio_digital": True, "redes": True},
